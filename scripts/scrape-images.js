...
const tokens = [
    ...
    { tokenId: '0.0.1317440', name: 'Pixel Land - NumSkullz', ext: 'png' }, // couple of images result in 404: 363 - 403 - 565 - 573 - 639 - 761 - 830 - 836 - 952 - 1030 - 1032 - 1190 - 1381 - 1436 - 1619 - 1757 - 1793 - 1838
...
async function scrapeImages() {
    ...
    for (let i = 0; i < tokens.length; i++) {
        ...
        for (let j = 1; j <= nftData.data.length; j++) {
